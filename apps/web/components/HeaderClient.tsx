...
import type { SocialUrls } from "@/lib/social-urls";
...
export function HeaderClient({ socials }: HeaderClientProps) {
  ...
  const SOCIAL_ICONS = [
    { id: "instagram", Icon: Instagram, href: socials.instagram, label: "Instagram" },
    { id: "telegram", Icon: Send, href: socials.telegram, label: "Telegram" },
    { id: "vk", Icon: VKIcon, href: socials.vk, label: "VK" },
  ];
