    ...
    <section id="social" className="relative bg-slate-50/60 py-14 md:py-20">
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-3 md:gap-6">
          {CHANNELS.map(({ id, Icon, label, handle, followers, accent }) => (
            <a
              key={id}
              href="#"
              target="_blank"
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  <p className="font-display text-lg leading-none text-slate-900">{label}</p>
                  <p className="truncate text-sm text-slate-500">{handle}</p>
                </div>
              </div>
              <div className="mt-5 flex items-center justify-between border-t border-slate-100 pt-4 text-sm">
                <div>
                  <p className="font-display text-2xl tabular-nums text-slate-900">{followers}</p>
